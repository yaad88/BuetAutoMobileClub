...
$var= "SELECT * FROM event WHERE MemberId=".$_SESSION['memberId'];
...
if($numOfTask>0)
{
  ...
  while ($row=$result->fetch_assoc()) {
    $array[$index]=array('EventName'=>$row['EventName'],'Date'=>$row['Date'],'Command'=>$row['Command']);
    $index=$index+1;
  }
}
//print_r($array);
          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation">
              <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link smooth-scroll" href="task.php">Assign Task</a></li>
                <li class="nav-item"><a class="nav-link smooth-scroll" href="feedback.php">Give Feedback</a></li>
