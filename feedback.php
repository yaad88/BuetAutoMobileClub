			...
			<div class="container">
				...
				<nav id="nav">
					<ul class="main-menu nav navbar-nav navbar-right">
						...
						<li><a href="#" style ="color:black; ">Current Works</a></li>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-10 col-md-offset-1 text-center">
						...
						<h1 class="white-text">Feedback Page</h1>
						<form action="./controller/FeedBack.php" method="post" enctype="multipart/form-data">
							...
							<h3 align="left" style="margin-top:20px;color:white;"> Enter the feedbacking event name</h3> 
							<input name="ename" type="text" style="margin-top:20px;color:white;">
							
							<h3 align="left" style="margin-top:20px;color:white;"> Place Feedback </h3> 
							<textarea name = "feedback" placeholder="Event Description" rows = "80" cols = "80" style="margin-top:20px;color:white;"> </textarea>
